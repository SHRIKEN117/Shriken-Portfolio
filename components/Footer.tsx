export default function Footer() {
  ...
  return (
    <footer
      className="py-8 max-w-6xl mx-auto px-6"
    ...
    >
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <p className="font-mono text-xs text-[#6e727a] text-center">
          Designed &amp; built by Shriken Patel · {new Date().getFullYear()}
        </p>
        <div className="flex items-center gap-4">
          {socials.map((s) => (
            <a
              ...
              className="text-[#6e727a] hover:text-[#52e1fe] transition-colors duration-150"
              aria-label={s.label}
            >
              {s.icon}
            </a>
