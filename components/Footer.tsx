export default function Footer() {
  ...
  return (
    <footer className="border-t border-[#333333] py-10 max-w-6xl mx-auto px-6">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="font-body font-medium text-sm text-white">
          SP<span className="text-[#999999]">&nbsp;/&nbsp;dev</span>
        </div>
        <p className="font-mono text-xs text-[#999999] text-center">
