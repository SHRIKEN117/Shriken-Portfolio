...
export const StackFlowIntegrator = () => {
  return (
    <section
      className={cn(
    ...
    >
      ...
      <div
        className={cn(
          ...
          'dark:bg-[radial-gradient(closest-side,rgba(0,212,255,0.18),transparent_70%)]',
      ...
      <div className="pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
        <FloatingOrb style={{ top: '25%', left: '25%', animationDelay: '0s' }} />
        <FloatingOrb style={{ top: '33%', right: '33%', animationDelay: '0.5s' }} />
        <FloatingOrb style={{ bottom: '25%', left: '33%', animationDelay: '1s' }} />
        <FloatingOrb style={{ bottom: '33%', right: '25%', animationDelay: '1.5s' }} />
      </div>
      ...
      <div className="relative p-12 md:p-16">
        ...
        <div className="mx-auto mt-14 grid grid-cols-3 gap-8 md:gap-12 place-items-center max-w-[560px]">
          <div />
          <IconTile>
            <SiReact className="h-10 w-10 text-[#00D4FF] dark:text-[#00D4FF]" />
          </IconTile>
          <div />

          <IconTile>
            <SiTailwindcss className="h-10 w-10 text-[#00D4FF] dark:text-[#00D4FF]" />
          </IconTile>
          <div />
          <IconTile>
            <div className="relative flex items-center">
              <LuSlash className="h-9 w-9 text-[#7C3AED] dark:text-[#7C3AED]" />
              <LuSlash className="h-9 w-9 -ml-3 text-[#7C3AED]/80 dark:text-[#7C3AED]/80" />
            </div>
          </IconTile>
          ...
          <IconTile>
            <div className="flex h-10 w-10 items-center justify-center rounded-md bg-neutral-200 dark:bg-white/10 ring-1 ring-black/10 dark:ring-white/20">
              <span className="text-sm font-black tracking-tight text-[#00D4FF] dark:text-[#00D4FF]">
                TS
              </span>
            </div>
          </IconTile>
...
function IconTile({
  ...
  return (
    <div
      className={cn(
        'group/tile relative h-28 w-28 md:h-32 md:w-32',
